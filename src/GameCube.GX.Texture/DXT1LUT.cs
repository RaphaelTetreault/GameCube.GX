namespace GameCube.GX.Texture
{
    ...
    {
        public class SingleColourLookupTable
        {
            public readonly SingleColourLookup[] singleColourLookups;

            public SingleColourLookupTable(params SingleColourLookup[] singleColourLookups)
            {
                this.singleColourLookups = singleColourLookups;
            }
        }

        public struct SingleColourLookup
        {
            public readonly SourceBlock[] sourceBlocks; // length 2

            public SingleColourLookup(params SourceBlock[] sourceBlocks)
            {
                bool isValid = sourceBlocks.Length == 2;
                if (!isValid)
        ...
        public static readonly SingleColourLookupTable lookup_5_3 = new SingleColourLookupTable(
        ...
        public static readonly SingleColourLookupTable lookup_6_3 = new SingleColourLookupTable(
            new SingleColourLookup(new SourceBlock(0, 0, 0), new SourceBlock(0, 0, 0)),
        ...
        public static readonly SingleColourLookupTable lookup_5_4 = new SingleColourLookupTable(
            new SingleColourLookup(new SourceBlock(0, 0, 0), new SourceBlock(0, 0, 0)),
            new SingleColourLookup(new SourceBlock(0, 0, 1), new SourceBlock(0, 1, 1)),
            new SingleColourLookup(new SourceBlock(0, 0, 2), new SourceBlock(0, 1, 0)),
            new SingleColourLookup(new SourceBlock(0, 0, 3), new SourceBlock(0, 1, 1)),
        ...
        public static readonly SingleColourLookupTable lookup_6_4 = new SingleColourLookupTable(
            new SingleColourLookup(new SourceBlock(0, 0, 0), new SourceBlock(0, 0, 0)),
